...
Version complète avec toutes les données (v3)
"""
...
# Données complètes des itinéraires et hôtels selon la liste fournie
ITINERAIRES_HOTELS = {
    "Antananarivo": [
    ...
    "Descente du Tsiribihina": [
        ("Chaland moteur (1 pers)", 2800000),  # Prix total pour 1 personne
        ("Chaland moteur (2 pers)", 1500000),  # Prix par personne pour 2 personnes
        ("Chaland moteur (3 pers)", 1200000),  # Prix par personne pour 3 personnes
        ("Chaland moteur (4-8 pers)", 900000),  # Prix par personne pour 4-8 personnes
    ],
    "Bekopaka": [
    ...
    "Morondava": [
        ...
        ("Vezo Beach", 470000),  # Corrigé: Vezo Beach au lieu de Yezo Beach
        ("Kily house", 310000),
        ("Laguna Beach", 489000),
    ],
    "Ifaty": [
    ...
    "Ranohira": [
        ("Jardin du roi", 810000),  # Déplacé depuis Ifaty
        ("Hotel H1", 320000),
        ("Isalo Rock Lodge", 710000),
    ],
    "Fianarantsoa": [
        ("Zomatel", 340000),
        ("La rizière", 210000),  # Corrigé: La rizière au lieu de La rizieres
        ("Tripolitsa", 290000),
        ("Ambalakely", 320000),
    ],
    "PN Ranomafana": [
    ...
    "Nosy Be": [
        ("Tsarakomba Miavana tide", 1200000),  # Ajouté
        ("Anjiamarongo Beach Ressort", 410000),
        ("Nosy Lodge", 410000),
        ("Nosy Be Hotel and Spa", 750000),
        ("Ravintsara Wellness", 1280000),  # Ajouté
        ("L'heure Bleu", 995000),  # Ajouté
        ("Eden Lodge", 2900000),
        ("Royal Beach", 1800000),
    ],
    "Sainte Marie": [
        ("Princesse Bora Lodge", 1870000),  # Déplacé depuis Nosy Be
        ("Mantis Soanambo", 1450000),  # Ajouté
    ],
    "Akany ny Nofy": [
        ("Palmarium beach", 380000),
    ],
    "Transfert Bateaux Palmarium": [
        ("Transfert Bateaux Palmarium", 600000),  # Service de transfert
    ],
    "Andasibe": [
        ("Feon'ny Ala", 180000),
        ("Andasibe Cyperus - Bungalow double", 375000),
        ("Andasibe Cyperus - Bungalow familial", 535000),
        ("Andasibe Cyperus - Chambre", 280000),
        ("Andasibe Cyperus - Chambre Familiale", 390000),
        ("Andasibe Cyperus Lodge", 290000),
        ("Mantadia Lodge", 850000),
        ("Relais de Mantadia", 550000),
        ("Manjarano Lodge", 1200000),
    ],
...
VISITES_PAR_LOCALITE = {
    "Andasibe": [
        ("Pereyras", 25000, 0, "personne", True, 45000, 3, "par_groupe", 10000),  # Taxe communale
        ("Reserve de Mitsinjo", 65000, 0, "personne", False, 0, 0, "par_groupe", 10000),
        ("Voimma nocturna", 45000, 0, "personne", False, 0, 0, "par_groupe", 10000),
        ("PN Analamazaotra", 90000, 0, "personne", True, 120000, 4, "par_groupe", 10000),
        ("PN Mantadia", 90000, 0, "personne", True, 120000, 4, "par_groupe", 10000),
        ("Reserve de Vakona", 50000, 0, "personne", False, 0, 0, "par_groupe", 10000),
        ("Voimma Diurne", 60000, 0, "personne", False, 0, 0, "par_groupe", 10000),
    ],
    "Antananarivo": [
    ...
    "Ranomafana": [
        ("PN Ranomafana", 110000, 0, "personne", True, 150000, 4, "par_groupe", 10000),  # Taxe communale
        ("Arboretum", 50000, 0, "personne", False, 0, 0, "par_groupe", 10000),
        ("Immersion Tanala", 90000, 0, "personne", False, 0, 0, "par_groupe", 10000),
    ],
    "Fianarantsoa": [
    ...
    "Ranohira": [
        ("PN de isalo", 130000, 0, "personne", True, 240000, 4, "par_groupe", 10000),  # Taxe communale
        ("Fenetre Isalo", 60000, 0, "personne", False, 0, 0, "par_groupe", 10000),
    ],
    "Ifaty": [
    ...
    "Bekopaka": [
        ("Bacc Tsimafana", 0, 200000, "voiture", False, 0, 0, "par_groupe", 10000),  # Taxe communale
        ("Bacc Manambolo", 0, 100000, "voiture", False, 0, 0, "par_groupe", 10000),
        ("Pirogue Manambolo", 50000, 0, "personne", False, 0, 0, "par_groupe", 10000),
        ("PN Tsingy de Bemaraha", 110000, 0, "personne", True, 260000, 4, "par_groupe", 10000),
        ("Droit de roulage", 0, 20000, "voiture", False, 0, 0, "par_groupe", 0),  # Pas de taxe sur droit de roulage
    ],
    "Diego Suarez": [
        ("3 baies de Diego", 40000, 0, "personne", True, 150000, 1, "par_voiture", 10000),  # Taxe communale
        ("PN Montagne d'ambre", 110000, 0, "personne", True, 200000, 4, "par_groupe", 10000),
        ("Mer emeraudes", 150000, 0, "personne", False, 0, 0, "par_groupe", 10000),
        ("Tsingy rouge", 60000, 0, "personne", True, 25000, 1, "par_personne", 10000),
        ("PN Ankarana", 130000, 0, "personne", True, 200000, 4, "par_groupe", 10000),
    ],
    "Ankify": [
...
# Taxes communales par localité (par personne)
TAXES_COMMUNALES = {
    "Andasibe": 10000,
    "Ranomafana": 10000,
    "Ranohira": 10000,
...
# Types de voitures avec leurs consommations (litres pour 100 km)
TYPES_VOITURES = [
    ("SUV", 13.0),
    ("Terracan", 15.0),
    ("Nissan", 15.0),
...
def insert_data():
    """Insère les itinéraires, hôtels, visites et types de voitures dans la base de données"""
    conn = connect_db()
    if not conn:
        return
    ...
    try:
        ...
        # 2. Insérer les itinéraires (tous les itinéraires, y compris ceux sans hôtels)
        print("\n2. Insertion des itinéraires...")
        itineraire_ids = {}
        ordre = 1
        
        # Récupérer tous les itinéraires uniques
...
if __name__ == "__main__":
    print("=" * 80)
    print("INSERTION COMPLÈTE DES ITINÉRAIRES ET HÔTELS")
    print("=" * 80)
    insert_data()
    print("\n" + "=" * 80)
